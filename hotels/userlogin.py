...
<style>
  .card {
    ...
    padding: 20px;
    margin-top: 20px;
    background-image: url(./media/admlog2.jpeg);
        ...
        <form method="post" enctype="Multipart/form-data">
          <div class="card bg-info">
            <div class="form-group">
              <center>
                <h2 style="color:white;font-family: bold;">User login </h2>
              </center>
              ...
              <center>
                ...
                <a href="usrforgotpsw.py" style="text-decoration:none;font-size:20px;font-family:bold;color:white">Forgot Password</a>
      ...
      <div class="container-fluid" style="background-color: rgb(71, 9, 14);padding-top: 40px;">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <p style="padding-left: 40px; font-weight: bold; padding-bottom: 50px;color: white;">7,1st Floor,<br> Sri
              Sairam Tower,
              NSR Rd,<br> Nesavaalar Colony, Saibaba Koil,<br> Coimbatore, Tamil Nadu 641011</p>
          </div>
          <div class="col-md-3"></div>
...
m=cgi.FieldStorage()
username=m.getvalue("email")
password=m.getvalue("psw")
submit=m.getvalue("sub")
if submit !=None:
  q="""select id from userreg where Name='%s' and Password='%s' """ %(username,password)
  cur.execute(q)
  res=cur.fetchone()
  print("""
  <script>
  alert("Logged In");
  location.href="customerdashboard.py?id=%s";
  </script>
  """%(res[0]))
