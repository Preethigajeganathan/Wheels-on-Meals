...
""")
r="""select * from booking where Ownername='%s' and status="New" and booktype="Order" """%(name)
cur.execute(r)
rec=cur.fetchall()
for c in rec:
    ...
    <td><input type="submit" class="btn btn-success" name="sub" value="Accept"></td>
    </tr>
    </form>
...
if submit !=None:
    ...
    body = "The order is Picked by: {}".format(hotel)
    msg = """Subject: {} \n\n{}""".format(subject, body)
    ...
    print("""
        ...
        location.href="own_allorders.py?id=%s"
        </script>
         """ %(b))
