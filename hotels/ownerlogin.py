        ...
        <form method="post" enctype="Multipart/form-data">
          <div class="card bg-info">
            <div class="form-group">
              <center>
                <h2 style="color:white;font-family: bold;">Owner login </h2>
              </center>
              <label for="">Email id</label>
              <input type="email" class="form-control" name="usr" id="email">
              ...
              <center>
                ...
                <a href="ownerforgotpsw.py" style="text-decoration:none;font-size:20px;font-family:bold;color:white">Forgot Password</a>
              </center>
...
if submit !=None:
  q="""select id from ownerreg where Emailid='%s' and Password='%s' """ %(username,password)
  cur.execute(q)
  res=cur.fetchone()
  print("""
  <script>
  alert("Logged In");
  location.href="ownerdashboard.py?id=%s";
  </script>
  """ %(res))
